...
mkdir -p /run/apache2/ &&\
apk add apache2=2.4.23-r3 apache2-utils=2.4.23-r3 php5-zlib php5-zip php5-apache2 php5-gettext php5-cgi php5-gd php5-intl php5-iconv php5-mcrypt patch php5-imap php5-json php5-curl php5-xml php5-soap php5-dom php5-calendar wget php5-openssl &&\
